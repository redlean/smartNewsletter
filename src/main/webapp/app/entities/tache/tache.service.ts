...
export class TacheService {
    ...
    /**
     * Convert a returned JSON object to Tache.
     */
    private convertItemFromServer(json: any): Tache {
        const entity: Tache = Object.assign(new Tache(), json);
        return entity;
    }

    /**
     * Convert a Tache to a JSON which can be sent to the server.
     */
